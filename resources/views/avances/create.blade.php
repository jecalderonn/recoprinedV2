...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li claavancesveproyecto_">Registrar Avances</proyecto_li>
	</ol>
</section>
<section class="content container-fluid">
	<div class="box box-warning">
            ...
            <div class="box-body">
              	{!!Form::open(['route'=>'avances.store', 'method'=>'POST', 'files'=> true])!!}
            ...
            <label for="proyecto">Proyecto</label>
               ...
               <select  class="form-control" id="proyecto" name="proyecto">
                  ...
                  @endforeach
					...
					<label for="url">Avance</label><input id="url" type="file" name="url" class="form-control" placeholder="Subir archivo de anexo">
